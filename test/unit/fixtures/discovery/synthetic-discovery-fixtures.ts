...
export const SYNTHETIC_DISCOVERY_CASE_IDS = Object.freeze([
	...
	'wrong-namespace-principal-required-property',
	'wrong-namespace-home-required-property',
	'malformed-xml-principal',
	'malformed-xml-home',
	'malformed-xml-collection',
	'resource-type-filtering',
	'successful-over-failed-collection-property',
	'duplicate-successful-collection-property',
	'denied-redirect-leakage',
	'native-error-leakage',
	'offline-no-network',
